...
export default function App() {
  ...
  // Water daily target update
  const handleUpdateWaterTarget = (newTargetMl: number) => {
    const updatedGoals = { ...userGoals, waterTargetMl: newTargetMl };
    setUserGoals(updatedGoals);
    saveStoredGoals(updatedGoals);
    showToast(`Meta diária de água atualizada para ${(newTargetMl / 1000).toFixed(1)}L!`);
  };
      ...
      <main className="max-w-5xl mx-auto px-4 pt-6 pb-24 md:pb-20">
        ...
        {activeTab === "dashboard" && (
          <Dashboard
            ...
            onUpdateWaterTarget={handleUpdateWaterTarget}
